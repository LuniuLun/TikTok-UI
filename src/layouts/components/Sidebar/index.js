...
import { HomeIcon, UserGroupIcon, LiveIcon, HomeIconActive, UserGroupIconActive, LiveIconActive, ExploreIcon, ExploreIconActive } from "~/components/Icon";
    ...
    return (
        <aside className={cx('wrapper')}>
            <Menu>
                ...
                <MenuItem title='Explore' to={config.routes.explore} icon={<ExploreIcon/>} activeIcon={<ExploreIconActive/>}/>
